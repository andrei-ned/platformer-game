...
void D3DHandler::CreateDepthStencilDescription(D3D11_TEXTURE2D_DESC& dsd, int screenWidth, int screenHeight, bool msaa4X, int maxQuality)
{
...
void D3DHandler::SetViewportDimensions(int screenWidth, int screenHeight)
{
...
void D3DHandler::CreateSwapChain(DXGI_SWAP_CHAIN_DESC& sd)
{
