...
{
	assert(mpTexture);
	camera.drawSprite(mpTexture, mpGameObject->mPos, &mTextureRect, mColor, mpGameObject->mRotation, mOrigin, mpGameObject->mScale * mScale, mpGameObject->mIsInWorldSpace, mSpriteEffects);
}
