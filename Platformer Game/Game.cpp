...
Game::Game(D3DHandler& d3d, SpriteBatch& spriteBatch) : mCamera(spriteBatch, d3d.GetScreenViewport()) {
	//mPlayer.addComponent<Sprite>()->setTexture(*TextureCache::get().LoadTexture("Player/Idle.png", false), { 43, 28, 117, 102 });
	...
	//// Floor
	//mTerrain.at(0).addComponent<Sprite>()->setTexture(*TextureCache::get().LoadTexture("Tiles/Dirt.png", false), { 0, 0, GameConstants::SCREEN_RES_X, 128 });
	...
	//// Walls
	//mTerrain.at(1).addComponent<Sprite>()->setTexture(*TextureCache::get().LoadTexture("Tiles/Dirt.png", false), { 0, 0, 64, GameConstants::SCREEN_RES_Y });
	//mTerrain.at(1).mPos = Vector2(0, 0);
	//mTerrainColliders.push_back(mTerrain.at(1).addComponent<Collider>());
	//mTerrain.at(2).addComponent<Sprite>()->setTexture(*TextureCache::get().LoadTexture("Tiles/Dirt.png", false), { 0, 0, 64, GameConstants::SCREEN_RES_Y });
	...
	//// Platforms
	//mTerrain.at(3).addComponent<Sprite>()->setTexture(*TextureCache::get().LoadTexture("Tiles/Dirt.png", false), { 0, 0, 128, 64 });
	//mTerrain.at(3).mPos = Vector2(500, 300);
	//mTerrainColliders.push_back(mTerrain.at(3).addComponent<Collider>());
	//mTerrain.at(4).addComponent<Sprite>()->setTexture(*TextureCache::get().LoadTexture("Tiles/Dirt.png", false), { 0, 0, 256, 64 });
	...
	//{
	//	mBackgrounds.at(i).addComponent<Sprite>()->setTexture(*TextureCache::get().LoadTexture("Backgrounds/bg" + std::to_string(i) + ".png", false), { 0, 1, GameConstants::SCREEN_RES_X, 1080 });
